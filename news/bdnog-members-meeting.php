            ...
            <section class="wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <div>
                                <p style="text-align:justify"><b>bdNOG Members Meeting</b></p>

                                <p style="text-align:justify">Date: 7th November, 2013
                                    <br> Location: Baton Rouge Dhaka</p>

                                <p style="text-align:justify">bdNOG recently had a successful general meeting held on November 7, 2013 at Baton Rouge Restaurant Dhaka. There were 30 invited people attended the 1st general meeting who has got previous experience on other NOG activities.</p>

                                <p style="text-align:justify">We have decided on a number of agenda and action items. Meeting minutes and 1st year action plan presentation will be published on bdNOG website by the end of November, 2013.</p>

                                <p style="text-align:justify">
                                    <div class="row">
                                        <!-- start: GROUP PHOTO -->
                                        <div class="col-md-8">
                                            <img src="materials/img/DSC_0596.jpg" class="img-responsive">
                                            <br>
                                            <img src="materials/img/DSC_0597.jpg" class="img-responsive">
                                            <br>
                                            <img src="materials/img/DSC_0599.jpg" class="img-responsive">
                                            <br>
                                            <img src="materials/img/DSC_0605.jpg" class="img-responsive">
                                            <br>
                                            <img src="materials/img/DSC_0610.jpg" class="img-responsive">
                                            <br>
                                            <img src="materials/img/DSC_0613.jpg" class="img-responsive">
                                            <br>
                                        </div>
                                        <!-- end: GROUP PHOTO -->
                                    </div>
                                ...
                                <p style="text-align:justify"><a href="../Member_Meetings.php">Meeting minutes and presentation are available here</a></p>

                            </div>
                        </div>
                        <div class="col-lg-4">
                            <!-- start: SPONSORS SLIDER -->
                            <?php include('../sponsors_slider_news.php'); ?>
                                <!-- end: SPONSORS SLIDER -->
                        </div>
                    </div>
                </div>
