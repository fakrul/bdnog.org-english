            ...
            <section class="page-top">
                <div class="container">
                    <div class="col-md-4 col-sm-4">
                        <h1>Stakeholder Coordination</h1>
                    </div>
            ...
            <section class="wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <div>
                                <p style="text-align:justify">bdNOG support the current multi-stake holder model of Internet operation and work co-operatively with several Internet related organization i.e. <a href="http://www.apnic.net/" target="_blank">APNIC</a>, <a href="http://www.apricot.net/" target="_blank">APRICOT</a>, <a href="https://www.internetsociety.org/" target="_blank">ISOC</a>, several regional NOGs etc.
                                </p>
                                <p>bdNOG works very co-operatively with <a href="http://www.sanog.org/" target="_blank">SANOG</a> which is a bigger umbrella in South Asia region. <a href="http://www.sanog.org/" target="_blank">SANOG</a> discuss regional issues and bdNOG cater more local content to the NOG community in Bangladesh.
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-4">
