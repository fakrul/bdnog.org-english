            ...
            <section class="wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <div>
                                To receive support to organize regular conferences and workshop bdNOG work more closely with different Internet stakeholder across the region. We highly appreciate the contribution from the following organization during the initial formation of bdNOG.
                                <p>
                                    <ul>
                                        <li><a href="http://www.apnic.net/" target="_blank">Asia Pacific Network Information Centre (APNIC)</a></li>
                                        <li><a href="http://www.nsrc.org/" target="_blank">Network Startup Resource Centre (NSRC)</a></li>
                                        <li><a href="http://www.bdnog.org/v2/bdnog-teincc-contract/" target="_blank">Trans-Eurasia Information Network Co operation Center (TEIN**CC)</a></li>
                                        <li><a href="https://www.apia.org/" target="_blank">Asia Pacific Internet Association (APIA)</a></li>
                                        <li><a href="http://www.internetsociety.org/" target="_blank">Internet Society</a></li>
                                        <li><a href="Bdnog-Event-Sponsors.php">Our Sponsors</a></li>
                                    </ul>
                                </p>
                            </div>
                        </div>
