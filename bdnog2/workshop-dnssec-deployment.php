        ...
        <div class="main-container">
                ...
                <div class="container">
                    ...
                    <div class="col-md-8 col-sm-8">
                        <ul class="pull-right breadcrumb">
                            ...
                            <li class="active">
                                bdNOG2 / Workshop / DNSSec Deployment
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <section class="wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <h2>DNSSec Deployment</h2><span class="label label-info">Workshop</span>
                            <br>
                            <br><span class="badge"><h5><a href="materials/bdNOG2_DNSSecWorkshop.zip">(Download Slides)</a></h5></span>
                            <br>
                            <br>
                            <p style="text-align:justify"><b>Synopsis:</b>
                                <br> The Domain Name System (DNS) is a critical part of Internet infrastructure and the largest distributed Internet directory service. DNS translates names to IP addresses, a required process for web navigation, email delivery, and other Internet functions. However, the DNS infrastructure is not secure enough unless the security mechanisms such as Transaction Signatures (TSIG) and DNS Security Extensions (DNSSEC) are implemented. To guarantee the availability and the secure Internet services, it is important for networking professionals to understand DNS Security / DNSSEC concepts, configurations, and operations.
                            </p>

                            <p style="text-align:justify"><b>Target Audience:</b>
                                <br>This course is designed for network engineers, systems administrators, and anyone who is involved in managing DNS operations.
                            </p>

                            <p style="text-align:justify"><b>Pre-requisites:</b>
                                <br>It is assumed that participants have a good understanding of networking fundamentals and a basic knowledge of Unix/Linux. It is also recommended that the participants attend WDNS01 course prior to attending this course.
                            </p>

                            <b>Course Outline:</b>
                            <ul>
                                <li>DNS Security concepts</li>
                                <li>DNS Protocol Vulnerabilities</li>
                                <li>Transaction Signatures (TSIG)</li>
                                <li>DNS Security Extensions (DNSSEC)</li>
                                <li>Setting up secure zones</li>
                                <li>DNSSEC Key management</li>
                            </ul>
                            <p style="text-align:justify"><b>Other requirements:</b>
                                <br>It is highly recommended that participants bring their own laptop computers (At least Pentium 4, 1gb Ram, DVD drive, with administrative access to system) to practice the lessons learned during the workshops.
                            </p>
                            ...
                            <div class="col-md-12">
                                ...
                                <img src="photo/bdnog2-dnssec.jpeg" class="img-responsive">
                            </div>
                        </div>
