            ...
            <section class="wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <div>
                                <p style="text-align:justify">bdNOG community conduct operational research on Bangladesh Internet infrastructure & operation by adopting an advance analytical method of collecting and analyzing data, find patters, co-relate those with Internet BCPs and RFCs. Present research report in bdNOG conference. Following research area includes and scope limited primarily to Bangladesh.
                                </p>
                                <ul>
                                    <li>Aggregation possibility of IPv4 and IPv6 prefixes primarily within Bangladesh</li>
                                    <li>Traffic pattern analysis and traffic engineering advocacy</li>
                                    <li>Traffic pattern analysis and peering advocacy</li>
                                    <li>Network security issue analysis and advocating security BCP implementation</li>
                                    <li>Analyzing multihoming requirement and advocating for multihoming BCPs</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4">
