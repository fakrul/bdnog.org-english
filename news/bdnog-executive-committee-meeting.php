            ...
            <section class="page-top">
                <div class="container">
                    <div class="col-md-4 col-sm-4">
                        <h1>bdNOG Executive Committee Meeting</h1>
                    </div>
                    <div class="col-md-8 col-sm-8">
                        <ul class="pull-right breadcrumb">
                            ...
                            <li class="active">
                                bdNOG Executive Committee Meeting
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div>
                                ...
                                <p style="text-align:justify">We have decided on a number of agenda and action items. Meeting minutes and 1st year action plan presentation is available from the URL below:</p>

                                <p style="text-align:justify"><a href="http://www.bdnog.org/Member_Meetings.php">http://www.bdnog.org/Member_Meetings.php</a></p>

                                <p style="text-align:justify">bdNOG mailing list is very active now. Lots of useful, in-depth discussions are happening everyday. All previous mailing list discussions are archived in the following URL:</p>

                                <p style="text-align:justify"><a href="http://www.bdnog.org/Mailing_List.php">http://www.bdnog.org/Mailing_List.php</a></p>
