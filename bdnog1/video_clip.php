                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <p>
                                <div class="col-md-12">
                                    <h4>bdNOG1 Workshop Video Clip</h4>
                                    <!-- BEGIN VIDEO -->
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/zdUlaIICVL8" frameborder="0" allowfullscreen></iframe>
                                    <!-- END VIDEO -->
                                </div>

                                <div class="col-md-12">
                                    <h4>bdNOG1 Conference Video Clip</h4>
                                    <!-- BEGIN VIDEO -->
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/HLBsODe3Ksw" frameborder="0" allowfullscreen></iframe>
                                    <!-- END VIDEO -->
                                </div>

                                <div class="col-md-12">
                                    <h4>Paul Wilson, Director General, APNIC. Keynote speaker at bdNOG1</h4>
                                    <!-- BEGIN VIDEO -->
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/BNQ4Rgs8vU4" frameborder="0" allowfullscreen></iframe>
                                    <!-- END VIDEO -->
                                </div>

                                <div class="col-md-12">
                                    <h4>Gaurab Raj Upadhaya, APNIC EC & Limelight Networks. Guest of Honour at bdNOG1</h4>
                                    <!-- BEGIN VIDEO -->
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/hYDRjIVSdCQ" frameborder="0" allowfullscreen></iframe>
                                    <!-- END VIDEO -->
                                </div>

                                <div class="col-md-12">
                                    <h4>Sumon Ahmed Sabir, CSO Fiber@Home, Chairman, bdNOG Board of Trustee at bdNOG1</h4>
                                    <!-- BEGIN VIDEO -->
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/qyl8GiI4mHo" frameborder="0" allowfullscreen></iframe>
                                    <!-- END VIDEO -->
                                </div>

                                <div class="col-md-12">
                                    <h4>bdNOG1 Pre-event Press Conference Video
</h4>
                                    <!-- BEGIN VIDEO -->
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/dB37r0M1qYU" frameborder="0" allowfullscreen></iframe>
                                    <!-- END VIDEO -->
                                </div>
                            </p>
                            <br>
