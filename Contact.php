                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div>
                                <p>Office Address:</p>
                                <p>
                                    <h5>Bangladesh Network Operators Group (bdNOG) </h5> Suit # 605, 154 Motijheel C/A
                                    <br> Dhaka-1000. Bangladesh.
                                    <br>
                                    <br> E-mail: info@bdnog.org
                                    <br> URL: www.bdnog.org
                                    <br>
                                    <br> Phone : + 880 2 7110971
                                    <br> Cell: +88 01714 038292
                                    <br>
                                </p>
                                <p class="text-info">Note: bdNOG is a voluntary initiative and we do not maintain regular telephone operator at the office. Our phone contact numbers are on best effort basis when someone is available to answer the call. We prefer all the secretariat related correspondence to sent to the e-mail address provided. We normally response to e-mail with in 24 hour.</p>
                            </div>
                        </div>
                        <div class="col-lg-4">
