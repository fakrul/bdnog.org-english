<?php
    ...
    if(!empty($_POST))
    {
        ...
        die("Redirecting to Executive_Committee.php");
    }
?>
                ...
                <section class="wrapper">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8">
                                <div>
                                    <p style="text-align:justify">bdNOG executive committee is the main management committee of bdNOG board. The Executive Committee oversee the overall management and function of bdNOG community. Members of the executive committee are selected to work for 2 years term and need to be the citizen of Bangladesh.
                                    </p>

                                    <p style="text-align:justify"><b>bdNOG is currently inviting expression of interest from Bangladesh citizen to volunteer for bdNOG executive committee.</b>
                                    </p>
                                    <br>

                                    <div class="col-lg-12 col-sm-12">
                                        <h4>EOI for Executive Committee</h4>

                                        <div class="contact-form">
                                            <form id="loginform" class="form-horizontal" role="form" action="Executive_Committee.php" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="contribution">What contribution you can make to EC *</label>
