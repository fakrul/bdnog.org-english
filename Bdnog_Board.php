            ...
            <section class="wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <div>
                                <p style="text-align:justify">Bangladesh Network Operators Group (bdNOG) is a trust in Bangladesh, a not for profit, voluntary based, Internet research and operational community welfare initiative.
                                </p>

                                <p style="text-align:justify">bdNOG board is the highest authority of the trust and approves its yearly activities and hold the <a href="Executive_Committee.php">Executive Committee (EC)</a> accountable to the board.
                                </p>

                                <p style="text-align:justify"><a href="Executive_Committee.php">Executive Committee</a> is the main management committee of bdNOG. It looks after the overall function and operation of this organization. Members of the <a href="Executive_Committee.php">Executive Committee</a> are selected by publishing an open Expression of Interest (EOI) on bdNOG website for two years term. All the members of bdNOG EC need to be a citizen of Bangladesh.
                                </p>

                                <p style="text-align:justify">There are two other committee to support regular activities of bdNOG:</p>
                                1. <a href="Advisory_Committee.php">Advisory Committee</a> to provide regular advise to the bdNOG board and EC.
                                <br> 2. <a href="Program_Committee.php">Program Committee</a> to arrange conference program for bdNOG.
                                <br>
                                <br>

                                <p style="text-align:justify">Please send an e-mail to info [at] bdnog.org to get the list of members serving on the different committee of bdNOG.
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-4">
